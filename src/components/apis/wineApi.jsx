export const fetchDeleteWine = (wineId, fnOnResolve, navigate) => {
    ...
    fetch(`http://localhost:3000/favorite-wines/${wineId}`, configObj)
    .then(() => fnOnResolve(wineId))
    .then(() => navigate("/wines"))
    .catch(console.log)
}

export const fetchPatchWine = (url, validFormData, handlePatchWine, toggleEditMode, handleError, navigate) => {
    fetch(url, {
        method: "PATCH",
        headers: {
